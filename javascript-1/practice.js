...
//state will be your current state or providence as a string. age will be your age as a number. greeter will be a method that returns the string 'Hello! My name is NAMEVALUE '
...
//Loop over the passed in arr param. If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' 
...
myNumbers.forEach(function(element){
	let index = myNumbers.indexOf(element);
...
let forTheLoveOfGeorge = [];
	...
	element = "George";
	forTheLoveOfGeorge.push(element)
})
//////////////////PROBLEM 19////////////////////
